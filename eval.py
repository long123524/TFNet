...
if __name__ == '__main__':
    GT_dir = r'E:\test\label'
    pred_dir = r'E:\result\pc'
    ...
    for idx, it in enumerate(data_list):
        if it[-4:]=='.tif' or it[-4:]=='.tif': num_valid+=1
    ...
    print('Eval results: Acc %.2f, precision %.2f, recall %.2f, F1 %.2f, IoU0 %.2f.'%(acc*100, precision*100, recall*100, F1*100, IoU0*100))
